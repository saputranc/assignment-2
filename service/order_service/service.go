...
type Service interface {
	...
	DeleteOrder(orderId int, newOrderRequest dto.NewOrderRequestDto) (*dto.NewOrderResponseDto, errs.Error)
}
...
func (os *orderService) DeleteOrder(orderId int, newOrderRequest dto.NewOrderRequestDto) (*dto.NewOrderResponseDto, errs.Error) {
	...
	err = os.OrderRepo.DeleteOrder(orderPayload, itemPayload)
